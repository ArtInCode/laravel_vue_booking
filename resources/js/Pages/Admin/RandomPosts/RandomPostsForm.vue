        ...
        <div class="m-auto w-1/2 py-12">
            <form @submit.prevent="submit">
                  <input type="hidden" name="_token" :value="csrf">
                    ...
                    <div class="w-full">
                        <InputLabel for="link_label" value="link_label" />
                        <TextInput
                            id="link_label"
                            type="text"
                            class="mt-1 block w-full"
...
const formAction = ref(route('random-post.store'));
if(typeof page.props.create !== 'undefined' && page.props.create === false){
    formFieldsData.value = {
        title: page.props.postItem.title,
        description: page.props.postItem.description,  
        link: page.props.postItem.link,
        link_label: page.props.postItem.link_label,
        image_id: page.props.postItem.image_id,
        group_key: page.props.postItem.group_key,
        status : page.props.postItem.status,
        fileName : (typeof page.props.postItem.media.name !== 'undedefined' ) ? page.props.postItem.media.name : ''  
    }
    formAction.value = route('random-post.update', {id : page.props.slider_id});
}
